...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] float decayRate = 14f;
        [SerializeField] float refillRate = 22.5f;
        ...
        private void Update()
        {
            ...
            if (Input.GetKey(KeyCode.LeftShift))
            {
                if (stamina > 0.01f)
                {
                    ...
                    staminaUI.fillAmount -= decayRate * Time.deltaTime;
                    stamina = staminaUI.fillAmount;
                }
            }
            ...
            if (!Input.GetKey(KeyCode.LeftShift))
            {
                if (stamina < maxStamina)
                {
                    ...
                    staminaUI.fillAmount += refillRate * Time.deltaTime;
                    stamina = staminaUI.fillAmount;
                }
            }
